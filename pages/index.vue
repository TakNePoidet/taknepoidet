<template>
	<main>
		<div id="home" ref="section-background-images" class="section-background-images">
		...
		<div id="social" class="section-social-networks social_networks">
			...
			<ul class="social_networks__links">
				...
				><a :href="item.link" target="_blank">
					<div class="social_networks__item__logo"><i :class="item.icon"/></div>
		...
		<div id="news" class="section-news">
			<h2 class="section-title">
				{{ $store.state.lang.section.news.title }}
			</h2>
			<div v-if="news.length > 1" class="news">
				<div v-for="item in news" :key="item.id" :class="['wow', 'bounceInUp', 'news__item']">
					<a :href="`https://vk.com/wall20513451_${item.id}`" target="_blank" class="news__link" rel="nofollow">
						<div class="news__cover">
							<img
								:src="$store.state.api + 'images/cover/' + item.photo[0]"
				...
				<div v-for="item of project" :key="item.link" class="project__item wow flipInX">
					<a :href="item.link" target="_blank">
						<div class="project__images">
							<img
								:src="`${$store.state.api}/images/projects/${item.images}.jpg`"
